...
class ClientApp:
    ...
    def buscar_cliente(self):
        ...
        resultado = self.cliente.buscar(id_cliente)  # Modifique aqui para chamar o método correto do modelo
        if resultado:
            ...
            self.lblMensagem.config(text="Cliente não encontrado!")
    ...
    def inserir_cliente(self):
        ...
        if nome and telefone and endereco and cpf:
            id_cliente = self.cliente.gerar_id()  # Método para gerar ID do cliente, se necessário
            self.cliente.inserir(id_cliente, nome, telefone, endereco, cpf)
            self.lblMensagem.config(text="Cliente inserido com sucesso!")
            self.limpar_campos()
        else:
    ...
    def alterar_cliente(self):
        ...
        endereco = self.txtEndereco.get()
        cpf = self.txtCPF.get()
        if id_cliente and nome and telefone and endereco and cpf:
            self.cliente.alterar(id_cliente, nome, telefone, endereco, cpf)
            self.lblMensagem.config(text="Cliente alterado com sucesso!")
            self.limpar_campos()
        else:
            messagebox.showwarning("Aviso", "Por favor, preencha todos os campos.")
    ...
    def excluir_cliente(self):
        ...
        if id_cliente:
            ...
            self.lblMensagem.config(text="Cliente excluído com sucesso!")
            self.limpar_campos()
        else:
