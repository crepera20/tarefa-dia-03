...
class Application:
    ...
    def buscar_usuario(self):
        ...
        try:
            idUsuario = int(idUsuario)  # Converte para inteiro
            ...
            self.lblMensagem.config(text="ID do usuário deve ser um número.")
    ...
    def inserir_usuario(self):
        ...
        if nome and telefone and email and usuario and senha:
            try:
                ...
                print(f"Erro: {e}")  # Adicione esta linha para imprimir o erro
                self.lblMensagem.config(text=f"Erro ao inserir usuário: {e}")
        else:
            self.lblMensagem.config(text="Por favor, preencha todos os campos!")
    ...
    def alterar_usuario(self):
        ...
        if idUsuario and nome and telefone and email and usuario and senha:
            try:
                ...
                self.lblMensagem.config(text=f"Erro ao alterar usuário: {e}")
        else:
            self.lblMensagem.config(text="Por favor, preencha todos os campos!")
    ...
    def excluir_usuario(self):
        ...
        if idUsuario:
            try:
                ...
                self.lblMensagem.config(text=f"Erro ao excluir usuário: {e}")
        else:
            self.lblMensagem.config(text="Por favor, insira o ID do usuário para excluir!")
